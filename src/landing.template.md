...
A curated catalog of skills for AI coding agents. Copy the line below into your agent at the start of a new project:

```text
fetch {{origin}}/start.md to start a new project
```
